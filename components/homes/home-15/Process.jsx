      ...
      <div className="flex flex-wrap mx-[-15px] !mb-5">
        <div className="md:w-10/12 lg:w-10/12 xl:w-8/12 xxl:w-7/12 w-full flex-[0_0_auto] !px-[15px] max-w-full !mx-auto !text-center">
          ...
          <h2 className="!text-[calc(1.305rem_+_0.66vw)] font-bold xl:!text-[1.8rem] !leading-[1.3] !mb-4 xl:!px-[4.5rem] lg:!px-[4.5rem]">
            Here are 4 working steps to organize our business projects.
          </h2>
        </div>
        {/* /column */}
      </div>
          ...
          <div className="card xl:!mr-6 lg:!mr-6">
            <div className="card-body p-6">
              <div className="flex flex-row">
                ...
                <div>
                  <h4 className="!mb-1">Architected to Scale</h4>
                  <p className="!mb-0">
                    We specialize in building multi-tenant SaaS products that grow with your business.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="card !mt-6 xl:!ml-16 lg:!ml-16">
            <div className="card-body p-6">
              <div className="flex flex-row">
                ...
                <div>
                  <h4 className="!mb-1">CTO-Led Execution</h4>
                  <p className="!mb-0">
                    Every engagement is guided by senior architects who’ve helped launch 20+ successful SaaS platforms.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="card !mt-6 xl:mx-6 lg:mx-6">
            <div className="card-body p-6">
              <div className="flex flex-row">
                ...
                <div>
                  <h4 className="!mb-1">Reusable IP = Faster Delivery</h4>
                  <p className="!mb-0">
                    We leverage proven starter kits, RBAC modules, and CI/CD workflows to reduce time-to-market.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="card !mt-6 xl:mx-6 lg:mx-6">
            <div className="card-body p-6">
              <div className="flex flex-row">
                ...
                <div>
                  <h4 className="!mb-1">Flexible Engagements</h4>
                  <p className="!mb-0">
                      From MVPs to long-term pods, we tailor our approach to your needs.
                  </p>
                </div>
              </div>
            </div>
